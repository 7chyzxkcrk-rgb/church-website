...
export default function Header() {
  ...
  return (
    <div className="relative overflow-hidden">
      ...
      {/* 회색 필터 */}
      <div className="absolute inset-0 flex flex-col" style={{backgroundColor: 'rgba(100,100,100,0.4)'}}>
        ...
        <div className="text-center px-4 flex-1 flex flex-col justify-start pt-4">
          ...
          <p className="text-white" style={{fontSize: 'clamp(11px, 1.5vw, 20px)'}}>그가 나를 푸른 풀밭에 누이시며 쉴 만한 물 가로 인도하시는도다</p>
          <p className="text-gray-300 mt-1" style={{fontSize: 'clamp(10px, 1.1vw, 15px)'}}>(시편 23:1-2)</p>

          <div className="mt-4 flex justify-center gap-4 text-gray-200" style={{fontSize: 'clamp(10px, 1.1vw, 15px)'}}>
