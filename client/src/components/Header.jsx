  ...
  return (
    <div>
      <div className="relative flex flex-col" style={{
        ...
        <div className="relative z-10 text-white text-center py-2 tracking-widest" style={{backgroundColor: 'rgba(101, 60, 20, 0.7)', fontSize: 'clamp(10px, 1.2vw, 16px)'}}>
        ...
        <div className="relative z-10 text-center px-4 flex-1 flex flex-col justify-center">
          ...
          <div className="hidden md:grid grid-cols-4 mt-8 pb-8 mx-auto" style={{gap: 'clamp(8px, 1.5vw, 24px)', maxWidth: 'clamp(400px, 50vw, 800px)'}}>
            {[
              ...
              <div key={card.title} className={`${card.bg} text-white cursor-pointer hover:opacity-90 transition-opacity rounded shadow-lg`}>
                <div className="w-full bg-gray-500 flex items-center justify-center rounded-t" style={{height: 'clamp(60px, 8vw, 140px)'}}>
